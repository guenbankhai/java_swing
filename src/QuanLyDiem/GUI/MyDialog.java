...
public class MyDialog extends JDialog {
    ...
    final ImageIcon iconError = new ImageIcon("img/cancel-icon.png");
    final ImageIcon iconSuccess = new ImageIcon("img/checkmark-icon.png");
    final ImageIcon iconInfo = new ImageIcon("img/info-icon.png");
    final ImageIcon iconWarning = new ImageIcon("img/warningshield-icon.png");
    ...
    private void addControls() {
        ...
        lblClose = new JLabel(new ImageIcon("img/x-icon.png"));
